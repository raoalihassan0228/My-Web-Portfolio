      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p>
              I&apos;m a professional full-stack developer specializing in the
              MERN stack. I bring expertise to crafting{" "}
            ...
            <p className="mt-4">
              Desired to{" "}
              <span className="font-semibold">
                conceptualize, build, and implement{" "}
              </span>
              innovative web solutions that meet your unique business needs.
              I&apos;m also a{" "}
              <span className="font-semibold">
                strong team player and effective communicator
              </span>
              , always collaborating closely with clients to ensure project
              success.
            </p>
            <p className="mb-8 mt-4 leading-relaxed">
              Currently I&apos;m enrolled in the Bachelor&apos;s of science in
              Data Science (4-Years Degree Program) at The Islamia University of
